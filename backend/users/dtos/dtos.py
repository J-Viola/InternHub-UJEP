...
class Adresa(BaseModel):
    ...
    kodStatu: Optional[str] = Field(None, description="Kód státu (ciselnikKod: Stat)")
...
class AdresaDorucovaci(BaseModel):
    ...
    radekAdresy1: Optional[str] = Field(None, description="řádek doručovací adresy")
    radekAdresy2: Optional[str] = Field(None, description="řádek doručovací adresy")
    radekAdresy3: Optional[str] = Field(None, description="řádek doručovací adresy")


class EkonomickySubjektDTO(BaseModel):
    description: Optional[str] = None
    ico: Optional[int] = None
